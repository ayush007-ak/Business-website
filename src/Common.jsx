            ...
            <div className="row">
                <div className="col-10 mx-auto" >
                    ...
                    <div className="col-md-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex justify-content-center flex-column">
                        <h1>{props.name} <strong className="brand-name">AyushTech</strong></h1>
                        <h2 className="my-3">Here i create website for bussiness and for other purpose with firebase hosting.</h2>
                        <div className="mt-3"> 
